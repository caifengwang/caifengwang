...
#define HomeUrl1    [NSURL URLWithString:@"http://192.168.0.156:8080/miningbee-web/toexamine.jsp"]
@interface PNSetupShopViewController ()<WKNavigationDelegate,UIWebViewDelegate,WKUIDelegate>
...
@implementation PNSetupShopViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    [self addTitleViewWithTitle:@"开店审核"];
    // [self configUI];// 有进度条的
    [self WebUI]; // 没有进度条的
