...
#define HomeUrl1    [NSURL URLWithString:@"http://bbs.caifengwang.cn/forum.php"]
@interface PNForumViewController ()<WKNavigationDelegate,UIWebViewDelegate,WKUIDelegate>
...
- (void)back{
    ...
    BOOL  flag = self.tabBarController.tabBar.hidden;
